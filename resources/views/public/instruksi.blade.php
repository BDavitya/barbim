...
@section('content')
    <img src="{{ asset('images/brush.png') }}" alt="Brush Top Right" class="position-absolute rotate-image"
        style="top: -50px; right: -60px; z-index: 0; max-width: 300px; pointer-events: none;">
    <img src="{{ asset('images/brush.png') }}" alt="Brush Bottom Left" class="position-absolute rotate-image"
    ...
    <div class="position-relative p-4 p-md-5 text-center text-muted bg-body rounded-5" style="border:#B7D7E8 1px dashed;">
        ...
        <div class="position-relative d-flex justify-content-center">
            ...
            <img src="{{ asset('images/hiu/spark.png') }}" alt="Spark Icon" class="position-absolute d-none d-sm-block"
